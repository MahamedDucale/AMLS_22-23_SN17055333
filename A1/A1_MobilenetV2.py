...
def create_data(train_img_dir, test_img_dir, index, train_labels_path, test_labels_path, val_percentage):
    ...
    train_labels = list(map(lambda x: 0 if x == -1 else 1, train_labels))
    test_labels = list(map(lambda x: 0 if x == -1 else 1, test_labels))
...
train_img_dir = "Datasets/celeba/img/"
test_img_dir = "Datasets/celeba_test/img/"
index = 2
train_labels_path = "Datasets/celeba/labels.csv"
test_labels_path = "Datasets/celeba_test/labels.csv"
val_percentage = 0.2
